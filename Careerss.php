...
<div class="section container"
    style="height: 100vh; display: flex; justify-content: center; align-items: center; margin-top: 50px;">
    <div class="container">
      <div class="row">
        <h1 class="heading text-center" data-aos="fade-up"><b>Careers</b></h1>
        <div class="col-lg-12 align-items-center mt-5" data-aos="fade-up" data-aos-delay="200">
          <form action="#">
            <div class="row">
            <div class="col-6 mb-3">
              ...
              <div class="col-6 mb-3">
                <p>Select Position (required)</p>
                <select class="form-select" required>
                  <option value="">Select an Option</option>
                  <option value="CP Sales" name="CPSales">CP Sales</option>
                  <option value="Receptionist/GRE" name="Receptionist/GRE">Receptionist/GRE</option>
                  <option value="CRM Executive" name="CRMExecutive">CRM Executive</option>
                  <option value="Chief Engineer/ Senior Project Manager" name="ChiefEngineer/SeniorProjectManager">Chief Engineer/ Senior Project Manager</option>
                </select>
              </div>
              <div class="col-6 mb-3">
